...
<div id="dialog-form" title="Событие">
    <form id="formAddEvent">
        ...
        <p><label for="event_start_date">Начало_Дата</label>
            <input type="text" name="event_start" id="event_start_date"/></p>
        <p><label for="event_start_time">Начало_Время</label>
            <input type="text" name="event_start" id="event_start_time"/></p>
